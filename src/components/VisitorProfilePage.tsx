...
export default function VisitorProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center pt-24 pb-28 px-4">
      ...
      {/* Profile Info */}
      <div className="w-full max-w-2xl px-6 md:px-10 pt-20 pb-6 flex flex-col">
      ...
      <div className="w-full max-w-2xl px-6 md:px-10 mt-8">
        <h2 className="text-2xl font-bold text-white mb-6">{profile.firstName || 'User'}`s Rides</h2>
